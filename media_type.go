...
// :v: 2018-05-24 13:36:58 C3031E                         [zr-web/media_type.go]
// -----------------------------------------------------------------------------

package web

//   MediaTypes = []struct
//   MediaType(name string) string
...
func MediaType(name string) string {
	...
	zr.Error(zr.EInvalid, "media type ^", name)
	return name
} //                                                                   MediaType
